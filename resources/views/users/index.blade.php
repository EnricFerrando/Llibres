...
<div class="container mt-5">
    ...
    <div class="row">
        @php
            @php
                $userAge = optional(Auth::user())->birth_date ? \Carbon\Carbon::parse(optional(Auth::user())->birth_date)->age : null;
            @endphp
        @endphp
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow bg-dark text-white">
                        @if(optional($book)->image)
                            <img src="{{ asset('storage/'.optional($book)->image) }}" class="card-img-top" alt="Portada de {{ optional($book)->title ?? '' }}" style="height: 300px; object-fit: cover;">
                        @else
                        ...
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title">{{ optional($book)->title ?? '-' }}</h5>
                            <div class="mb-2">
                                @php
